...
init_dist = [(0.781025641025641-0.0001, 0.781025641025641+0.0001), 
             (0.61, 0.9),
             (1, 10),  
             (0, 1), 
             (0.8, 1.2),
...
plt.savefig('corner'+fileone[:-4]+'.png')
#------------------------------------------------------------
#用输出值预测理论曲线
#
pre=predict(mu)
...
plt.title(fileone[:-4]+ '('+r'$R^{2}$'+'='+str(np.round(r_squared, 3))+')')
plt.savefig(fileone[:-4]+'.png')
