# -*- coding: utf-8 -*-
"""
Created on Mon Mar  7 14:15:23 2022
...
for i in range(0, 5000):
    ...
    predict10 = model10(nparraydata)
    predict10 = np.float32(predict10[0])
    predictdata = [T1, predict10[0]/90, predict10[1]/10, predict10[2]/100, predict10[3]/100]
#    print(predictdata)
...
test.to_csv('testcsv1.csv',encoding='gbk')