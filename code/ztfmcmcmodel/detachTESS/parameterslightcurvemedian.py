...
init_dist = [(0.71-0.0001, 0.71+0.0001), 
             (0.9, 1), 
             (0.1, 0.4), 
             (0, 1), 
             (0.9, 1.2),
...
'''
if index == 1:
    figure = corner.corner(emcee_trace.T[:,1:],bins=100,labels=[r"$incl$", r"$q$", r"$f$", r"$t2t1$", r"$l_3$"],
                       label_kwargs={"fontsize": 15},title_fmt='.4f',show_titles=True, title_kwargs={"fontsize": 15}, color ='blue',
                       fill_contours=True,smooth=10,smooth1d=10)
